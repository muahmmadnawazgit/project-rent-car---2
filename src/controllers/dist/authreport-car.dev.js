...
var nodemailer = require('nodemailer'); //const mailGun = require('nodemailer-mailgun-transport');
...
exports.home = function (req, res) {
  ...
  con.query('SELECT * FROM users WHERE email=?', [email], function (err, result) {
    ...
    if (result.length <= 0) {
      ...
      var sendEmail = function sendEmail(email, subject, textarea) {
...
//# sourceMappingURL=authreport-car.dev.js.map
